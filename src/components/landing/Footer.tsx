        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Client management made easy for service professionals
            </p>
          </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center space-x-6">
              <a
                href="https://t.me/mettly"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400"
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.223-.548.223l.188-2.85 5.18-4.686c.223-.198-.05-.308-.346-.11l-6.4 4.02-2.753-.857c-.597-.187-.608-.597.126-.885l10.753-4.12c.503-.18.94.126.8.832z"/>
                </svg>
              </a>
              <a
                href="https://instagram.com/mettly.io"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400"
              >
            ...
            <p className="text-gray-600 dark:text-gray-400">
              © {new Date().getFullYear()} metTly.io. All rights reserved.
            </p>
          </div>
        </div>
      </div>
